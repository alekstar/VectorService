...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/_ext/79280853/VectorServiceTest.o ${OBJECTFILES:%.o=%_nomain.o}
...
${TESTDIR}/_ext/79280853/VectorServiceTest.o: ../VectorService/tests/VectorServiceTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../gtest-1.7.0 -I../../gtest-1.7.0/include -I. -I../../gtest-1.7.0 -I../../gtest-1.7.0/include -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/79280853/VectorServiceTest.o ../VectorService/tests/VectorServiceTest.cpp
